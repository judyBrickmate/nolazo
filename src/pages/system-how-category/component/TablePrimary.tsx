...
export default function TablePrimary(props: any) {
  ...
  const column = ["No", "대분류 카테고리명", "대분류 코드", "공개여부", "등록일", "관리"];
  ...
  const listType = [
    ...
    { label: "대분류명", value: "name" },
    { label: "대분류코드", value: "categoryId" },
    ...
    <div className="root-container">
      ...
      <Box sx={{ mt: 4 }}>
        ...
        <StyledEngineProvider injectFirst>
          ...
          {openEdit && <EditCategoryModal categoryData={categoryData} setOpenEdit={setOpenEdit} getCategory={getCategory} listCategory={listCategory} />}
